...
const definition = {
  ...
  questions: [
    {
      key: "q_aim",
      prompt: "What is the aim of the experiment?",
      keywords: ["concentration", "standardise", "standardize", "molarity", "titration", "khp", "naoh"],
      fullMarksAt: 3,
      halfMarksAt: 1,
      points: 2,
      isRequired: true,
    ...
    {
      key: "q_water_volume",
      prompt: "Why does the volume of water used to dissolve KHP not need to be accurately measured?",
      keywords: ["moles", "amount", "unchanged", "same", "excess", "dissolve", "number"],
      fullMarksAt: 3,
      halfMarksAt: 1,
      points: 2,
      isRequired: true,
    ...
    {
      key: "q_water_type",
      prompt: "What type of water is used in this experiment and why?",
      keywords: ["distilled", "deionised", "deionized", "carbon dioxide", "co2", "ions", "impurities", "pure"],
      fullMarksAt: 3,
      halfMarksAt: 1,
      points: 2,
      isRequired: true,
    ...
    {
      key: "q_weighing_difference",
      prompt: "What is the advantage of weighing by difference?",
      keywords: ["transfer", "loss", "spill", "accurate", "exact", "remain", "sticking", "difference"],
      fullMarksAt: 3,
      halfMarksAt: 1,
      points: 2,
      isRequired: true,
    },
    {
      key: "q_naoh_effects",
      prompt:
        "What is the effect on the calculated NaOH molarity of (a) spilling some KHP before weighing, (b) splashing solution out of the flask during titration, (c) overshooting the endpoint?",
      keywords: ["higher", "increase", "greater", "lower", "decrease", "smaller", "volume", "titre", "overshoot"],
      fullMarksAt: 4,
      halfMarksAt: 2,
      points: 2,
      isRequired: true,
    },
    {
      key: "q_acid_effects",
      prompt:
        "What is the effect on the calculated moles of acid of (a) spilling some acid, (b) splashing solution out of the flask, (c) overshooting the endpoint?",
      keywords: ["lower", "fewer", "less", "decrease", "higher", "more", "increase", "endpoint", "excess"],
      fullMarksAt: 4,
      halfMarksAt: 2,
      points: 2,
      isRequired: true,
